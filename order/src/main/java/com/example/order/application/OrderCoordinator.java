...
import com.example.order.infrastructure.product.dto.ProductReserveApiRequest.ReserveItem;
...
public class OrderCoordinator {
  ...
  public void confirm(Long orderId) {
    ...
    try {
      ProductReserveConfirmApiRequest productReserveConfirmApiRequest = new ProductReserveConfirmApiRequest(orderId.toString());
